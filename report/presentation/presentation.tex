...
% имя фамилия отчество руководителей темы, курсовой
...
\titlegraphic{\includegraphics[scale=1.5]{Images/bmstu.pdf}} % Optional title page image, comment this line to remove it
