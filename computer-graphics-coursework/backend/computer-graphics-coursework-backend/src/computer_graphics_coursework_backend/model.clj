(ns computer-graphics-coursework-backend.model
  (:require [computer-graphics-coursework-backend.image :as i]
            [computer-graphics-coursework-backend.triangle :as t]
            [computer-graphics-coursework-backend.vector :as v]
            [computer-graphics-coursework-backend.color :as c]
            [computer-graphics-coursework-backend.matrix :as m]
