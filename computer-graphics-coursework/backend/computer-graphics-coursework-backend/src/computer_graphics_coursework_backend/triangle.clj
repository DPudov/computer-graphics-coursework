(ns computer-graphics-coursework-backend.triangle
  (:require [computer-graphics-coursework-backend.color :as c]
            [computer-graphics-coursework-backend.image :as i]
